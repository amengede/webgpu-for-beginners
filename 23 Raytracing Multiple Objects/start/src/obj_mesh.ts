...
export class ObjMesh {
    ...
    //TODO: add the following class members:
    //      triangleIndices: list of numbers
    //      nodes: list of Nodes
    //      nodesUsed: a number
    //      minCorner, maxCorner: vec3

    //TODO: remove all arguments
    constructor(position: vec3, eulers: vec3) {
        ...
        //TODO: initialize minCorner and maxCorner to impossible values
    }
    ...
    async initialize(color: vec3, url: string) {
        ...
        //TODO: v, vt & vn can be cleared now
        //TODO: now build the BVH
    }
    ...
    read_vertex_data(line: string) {
        ...
        //TODO: update the bounds of the bounding box
    }
