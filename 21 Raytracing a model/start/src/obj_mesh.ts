...
export class ObjMesh {
    ...
    //TODO: Make an array of triangles to store, add a variable to track the color of the model
    ...
    constructor() {
        ...
        //TODO: Initialise the triangle list
    }

    //TODO: take a color instead of a device
    async initialize(device: GPUDevice, url: string) {

        //TODO: Store the color then load the file
    ...
    read_face_data(line: string, result: number[]) {
       ...
       for (var i = 0; i < triangle_count; i++) {
            //TODO: make a triangle out of these three corners
    ...
    //TODO: Instead of storing into some result array, return data directly
